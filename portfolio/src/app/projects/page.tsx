  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center space-y-16 mt-16 w-full">
        ...
        {/* RockyBot - LLM Finance News Research Tool */}
        <Card
          isBlurred
          className="border-none bg-background/60 dark:bg-default-100/50 w-full max-w-[1150px] rounded-none"
          shadow="sm"
        ...
        >
          <CardBody>
            <div className="grid grid-cols-12 gap-6 md:gap-8 items-center">
              {/* Image Section */}
              <div className="col-span-12 md:col-span-5 flex justify-center">
                <div className="flex items-center justify-center w-full h-48 md:h-64 rounded-lg" style={{ backgroundColor: "#1565C0" }}>
                  <div className="text-center text-white p-6">
                    <div className="text-5xl mb-3">&#128200;&#129302;</div>
                    <div className="text-2xl font-bold">RockyBot</div>
                    <div className="text-sm opacity-90">Financial News Research</div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-12 md:col-span-7">
                ...
                <h1 className="text-2xl font-bold">
                  <a
                    href="https://github.com/pankhuri0209/LLMFinance"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:underline"
                  >
